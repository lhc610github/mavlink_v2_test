...
static void mavlink_test_ca_traject(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_CA_TRAJECT >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
    ...
    mavlink_ca_traject_t packet1, packet2;
        ...
        mav_array_memcpy(packet1.t, packet_in.t, sizeof(float)*2);
        mav_array_memcpy(packet1.trajectory_coefficient_x, packet_in.trajectory_coefficient_x, sizeof(float)*7);
        mav_array_memcpy(packet1.trajectory_coefficient_y, packet_in.trajectory_coefficient_y, sizeof(float)*7);
        mav_array_memcpy(packet1.trajectory_coefficient_z, packet_in.trajectory_coefficient_z, sizeof(float)*7);
        mav_array_memcpy(packet1.trajectory_coefficient_r, packet_in.trajectory_coefficient_r, sizeof(float)*7);
        
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_CA_TRAJECT_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_CA_TRAJECT_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_ca_traject_encode(system_id, component_id, &msg, &packet1);
...
static void mavlink_test_ca_traject_res(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_CA_TRAJECT_RES >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_ca_traject_res_t packet_in = {
        93372036854775807ULL,93372036854776311ULL,{ 129.0, 130.0, 131.0, 132.0 },{ 241.0, 242.0, 243.0, 244.0 },{ 353.0, 354.0, 355.0, 356.0 }
    };
    mavlink_ca_traject_res_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.time_usec = packet_in.time_usec;
        packet1.PC_time_usec = packet_in.PC_time_usec;
        
        mav_array_memcpy(packet1.P_d, packet_in.P_d, sizeof(float)*4);
        mav_array_memcpy(packet1.vel_d, packet_in.vel_d, sizeof(float)*4);
        mav_array_memcpy(packet1.acc_d, packet_in.acc_d, sizeof(float)*4);
        
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_CA_TRAJECT_RES_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_CA_TRAJECT_RES_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_ca_traject_res_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_ca_traject_res_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_ca_traject_res_pack(system_id, component_id, &msg , packet1.time_usec , packet1.PC_time_usec , packet1.P_d , packet1.vel_d , packet1.acc_d );
    mavlink_msg_ca_traject_res_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_ca_traject_res_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.time_usec , packet1.PC_time_usec , packet1.P_d , packet1.vel_d , packet1.acc_d );
    mavlink_msg_ca_traject_res_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_ca_traject_res_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_ca_traject_res_send(MAVLINK_COMM_1 , packet1.time_usec , packet1.PC_time_usec , packet1.P_d , packet1.vel_d , packet1.acc_d );
    mavlink_msg_ca_traject_res_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_ap_uavs_func_res(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_AP_UAVS_FUNC_RES >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_ap_uavs_func_res_t packet_in = {
        93372036854775807ULL,{ 73.0, 74.0, 75.0 },65
    };
    mavlink_ap_uavs_func_res_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.time_usec = packet_in.time_usec;
        packet1.num_uavs = packet_in.num_uavs;
        
        mav_array_memcpy(packet1.ap_ctrl_vel, packet_in.ap_ctrl_vel, sizeof(float)*3);
        
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_AP_UAVS_FUNC_RES_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_AP_UAVS_FUNC_RES_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_ap_uavs_func_res_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_ap_uavs_func_res_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_ap_uavs_func_res_pack(system_id, component_id, &msg , packet1.time_usec , packet1.num_uavs , packet1.ap_ctrl_vel );
    mavlink_msg_ap_uavs_func_res_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_ap_uavs_func_res_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.time_usec , packet1.num_uavs , packet1.ap_ctrl_vel );
    mavlink_msg_ap_uavs_func_res_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_ap_uavs_func_res_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_ap_uavs_func_res_send(MAVLINK_COMM_1 , packet1.time_usec , packet1.num_uavs , packet1.ap_ctrl_vel );
    mavlink_msg_ap_uavs_func_res_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
...
static void mavlink_test_common(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_test_ca_traject(system_id, component_id, last_msg);
    mavlink_test_ca_traject_res(system_id, component_id, last_msg);
    mavlink_test_ap_uavs_func_res(system_id, component_id, last_msg);
